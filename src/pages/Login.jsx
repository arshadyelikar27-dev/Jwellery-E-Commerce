    ...
    >
      <div style={{ maxWidth: '420px', margin: '0 auto' }}>
        ...
        <div style={{ padding: '2rem 1.5rem', background: '#fff', border: '1px solid var(--color-border)', borderRadius: '10px', boxShadow: '0 4px 15px rgba(0,0,0,0.03)' }}>
          <h2 style={{ fontSize: '1.6rem', marginBottom: '0.3rem' }}>Sign In</h2>
          <p style={{ color: 'var(--color-text-muted)', fontSize: '0.85rem', marginBottom: '1.5rem' }}>Access your account to view orders</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <button type="submit" className="btn btn-primary" style={{ marginTop: '0.5rem', width: '100%', padding: '0.8rem', borderRadius: '6px' }}>Sign In</button>
          </form>
          
          <p style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.88rem', color: 'var(--color-text-muted)' }}>
            Don't have an account? <Link to="/register" style={{ fontWeight: '600', color: 'var(--color-text)' }}>Sign Up</Link>
          </p>
        </div>
      </div>
    </motion.div>
