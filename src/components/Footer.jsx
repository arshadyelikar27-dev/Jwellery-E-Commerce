        ...
        <div className="footer-columns-grid">
          ...
          <div className="footer-brand-col">
            <Link to="/" className="footer-logo">
              <span className="logo-brand">SAFA</span>
            </Link>
            <p className="footer-about-text">
              Embodying the zenith of Parisian fine jewelry. Each SAFA creation is a certified masterpiece, harmonizing rare ethically-sourced diamonds with timeless artisanal precious metals.
            </p>
          ...
          <div className="footer-contact-col">
            ...
            <div className="contact-entry">
              ...
              <span>concierge@SAFA-paris.com</span>
            </div>
            <div className="contact-entry">
              <Phone size={16} className="contact-icon" />
              <span>+1 (800) 987-SAFA (24/7 VIP Concierge)</span>
            </div>
          </div>
        </div>
